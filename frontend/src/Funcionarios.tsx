    ...
    <div>
      ...
      >
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-navigation" style={{ display: 'flex', gap: '10px', marginTop: '20px' }}>
            {step > 1 && (
              <button type="button" onClick={handlePreviousStep} style={{ flex: 1 }}>
                Anterior
              </button>
            )}

            {step < 3 && (
              <button type="button" onClick={handleNextStep} style={{ flex: 1 }}>
                Próximo
              </button>
            )}
